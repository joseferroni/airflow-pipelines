...
# # ---------- Configuración ----------
# RUTA_STAGING = "/opt/airflow/data/entrada"
# DB_USER = "ventas"
# DB_PASSWORD = "ventas123"
# DB_HOST = "host.docker.internal"  # o "localhost" si lo pruebas fuera de Docker
# DB_PORT = 3306
# DB_NAME = "bd_ventas_sandbox"
# TABLA = "tabla_ventas_sandbox"
...
#     for root, dirs, files in os.walk(RUTA_STAGING):
#         for f in files:
#             if f.lower().endswith('ventas.xlsx'):
#                 fecha_archivo = f.split('_')[0]
#                 if fecha_archivo == fecha_hoy:
...
#                     print(f"[OK] Archivo '{f}' importado a MySQL en tabla '{TABLA}'.")

#     if not archivos_encontrados:
#         print(f"[INFO] No se encontraron archivos con fecha de hoy ({fecha_hoy}).")

# # ---------- DAG ----------
# with DAG(
#     dag_id="etl_excel_ventas",
...
#     tarea_crear_db = PythonOperator(
#         task_id="crear_base_si_no_existe",
#         python_callable=crear_base_si_no_existe
#     )

#     tarea_procesar_excel = PythonOperator(
#         task_id="procesar_excel",
#         python_callable=procesar_excel
#     )

#     # Flujo
#     tarea_crear_db >> tarea_procesar_excel